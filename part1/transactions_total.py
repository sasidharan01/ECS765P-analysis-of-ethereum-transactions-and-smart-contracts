...
if __name__ == "__main__":
    ...
    my_result_object = my_bucket_resource.Object(
        s3_bucket, "ethereum_" + date_time + "/transactions_total.txt"
    )
    my_result_object.put(Body=json.dumps(tot_transactions.take(100)))

    print(tot_transactions.take(100))
